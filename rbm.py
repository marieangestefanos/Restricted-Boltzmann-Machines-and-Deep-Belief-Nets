...
class RestrictedBoltzmannMachine:
    ...
    def cd1(self, visible_trainset, n_iterations=100, plotting=False):
        ...
        for iteration in range(n_iterations):
                ...
                if plotting:
                    if current_epoch >= 1:
                        ...
                        if id_batch == Nb_batch - 1: 
                            ...
                            loss_of_a_batch=np.mean(loss_list)  # Append avg loss epoch
            ...
            averages_loss.append(loss_of_a_batch)
        ...
        if plotting:
            ...
            plt.grid()
            plt.show()
        averages_loss= [averages_loss[i]/np.shape(averages_loss)[0] for i in range(len(averages_loss))]
        return averages_loss, error
